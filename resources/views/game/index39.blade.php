...
<head>
    <title>JEWEL IN WELL</title>
     <base href="http://renonights.live/" target="_blank">
    <link rel="stylesheet" href="games/game39/css/reset.css" type="text/css">
    <link rel="stylesheet" href="games/game39/css/main.css" type="text/css">
    <link rel="stylesheet" href="games/game39/css/orientation_utils.css" type="text/css">
    <link rel='shortcut icon' type='image/x-icon' href='./games/game39/favicon1.ico' />
    <link rel="stylesheet" href="games/game39/css/ios_fullscreen.css" type="text/css">
...
<body ondragstart="return false;" ondrop="return false;">
    ...
    <script type="text/javascript" src="games/game39/js/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="games/game39/js/createjs-2015.11.26.min.js"></script>
    <script type="text/javascript" src="games/game39/js/howler.min.js"></script>
    <script type="text/javascript" src="games/game39/js/main.js"></script>
    <script>
        ...
        $(document).ready(function() {
            ...
            function load(t) {
                var oMain = new CMain({
                    ...
                    freespin_occurrence: JSON.parse(t.game[0]['bonus']), //IF USER MUST WIN, SET THIS VALUE FOR FREESPIN OCCURRENCE
