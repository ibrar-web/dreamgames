...
<head>
    ...
    <link rel="stylesheet" href="games/game45/css/main.css" type="text/css">
    <!-- <link rel="stylesheet" href="css/orientation_utils.css" type="text/css"> -->
    <link rel='shortcut icon' type='image/x-icon' href='./games/game45/favicon.ico' />
    ...
    <script type="text/javascript" src="games/game45/js/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="games/game45/js/createjs-2015.11.26.min.js"></script>
    <script type="text/javascript" src="games/game45/js/howler.min.js"></script>
    <script type="text/javascript" src="games/game45/js/main.js"></script>
</head>
        ...
        $(document).ready(function() {
            ...
            function load(t) {
                var oMain = new CMain({
                    ...
                    time_show_all_wins: 5000, //DURATION IN MILLISECONDS OF ALL WINNING COMBO
