...
<head>
    <title>BILLIONAIRE SLOT</title>
     <base href="http://renonights.live/" target="_blank">
    <link rel="stylesheet" href="games/game35/css/reset.css" type="text/css">
    <link rel="stylesheet" href="games/game35/css/main.css" type="text/css">
    <link rel="stylesheet" href="games/game35/css/orientation_utils.css" type="text/css">
    <link rel='shortcut icon' type='image/x-icon' href='./games/game35/favicon1.ico' />
    <link rel="stylesheet" href="games/game35/css/ios_fullscreen.css" type="text/css">
    ...
    <script type="text/javascript" src="games/game35/js/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="games/game35/js/createjs-2015.11.26.min.js"></script>
    <script type="text/javascript" src="games/game35/js/howler.min.js"></script>
    <script type="text/javascript" src="games/game35/js/main.js"></script>
</head>
