function CInterface(){
   ...
   var bet;
    ...
    this.refreshMoney = function(szValue,val){
         //console.log(szValue,val);
         $.post("update5", { _token: $('meta[name=csrf-token]').attr('content'), amount: szValue ,type:val,bet:bet,user_id:user_id}, function (t) {
            _oMoneyDisplay.setText(t)
        });
