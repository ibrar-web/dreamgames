...
(function () {
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        d = function () {
            ...
            ], g = 0, h = e.length, b = {}; g < h; g++)
                if ((d = e[g]) && d[1] in a) { for (g = 0; g < d.length; g++) b[e[0][g]] = d[g]; return b }
            return !1
        }(),
        ...
        g = {
            request: function (e) {
                return new Promise(function (g, f) {
                    ...
                    Promise.resolve(e[d.requestFullscreen]())["catch"](f)
                }.bind(this))
            },
            exit: function () {
                return new Promise(function (e, g) {
                    if (this.isFullscreen) {
                        ...
                        this.on("change", f);
                        Promise.resolve(a[d.exitFullscreen]())["catch"](g)
                    } else e()
                }.bind(this))
            },
            toggle: function (a) { return this.isFullscreen ? this.exit() : this.request(a) },
            onchange: function (a) { this.on("change", a) },
            onerror: function (a) { this.on("error", a) },
            on: function (d, g) {
                var f = e[d];
                f && a.addEventListener(f, g, !1)
            },
            off: function (d, g) {
                var f = e[d];
                f && a.removeEventListener(f, g, !1)
            },
            raw: d
        };
...
(function () {
    ...
    function f(a, b) {
        var c = -1,
            d = a ? a.length : 0;
        if ("number" == typeof d && -1 < d && d <= r)
            for (; ++c < d;) b(a[c], c, a);
        else e(a, b)
    }

    function d(b) { b = String(b).replace(/^ +| +$/g, ""); return /^(?:webOS|i(?:OS|P))/.test(b) ? b : a(b) }

    function e(a, b) { for (var c in a) q.call(a, c) && b(a[c], c, a) }

    function g(b) { return null == b ? a(b) : z.call(b).slice(8, -1) }
    ...
    function k(a) { return String(a).replace(/([ -])(?!$)/g, "$1?") }

    function l(a, b) {
        var c = null;
        f(a, function (d, e) { c = b(c, d, e, a) });
        return c
    }
    ...
    function h(a) {
        function b(b) {
            return l(b, function (b, c) {
                ...
                !b && (b = RegExp("\\b" + e + " *\\d+[.\\w_]*", "i").exec(a) || RegExp("\\b" + e + " *\\w+-[\\w]*", "i").exec(a) || RegExp("\\b" + e + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(a)) && ((b = String(c.label && !RegExp(e, "i").test(c.label) ? c.label : b).split("/"))[1] && !/[\d.]+/.test(b[0]) && (b[0] +=
                    " " + b[1]), c = c.label || c, b = d(b[0].replace(RegExp(e, "i"), c).replace(RegExp("; *(?:" + c + "[_-])?", "i"), " ").replace(RegExp("(" + c + ")[-_.]?(\\w)", "i"), "$1 $2")));
                return b
            })
        }

        function f(b) { return l(b, function (b, c) { return b || (RegExp(c + "(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)", "i").exec(a) || 0)[1] || null }) }
        var r = c,
        ...
        var A = function (b) {
            ...
            v = function (b) { return l(b, function (b, c) { return b || RegExp("\\b" + (c.pattern || k(c)) + "\\b", "i").exec(a) && (c.label || c) }) }(["Adobe AIR", "Arora", "Avant Browser", "Breach", "Camino", "Electron", "Epiphany", "Fennec", "Flock", "Galeon", "GreenBrowser", "iCab", "Iceweasel", "K-Meleon", "Konqueror", "Lunascape", "Maxthon", { label: "Microsoft Edge", pattern: "Edge" }, "Midori", "Nook Browser",
            ...
            K = function (b) { return l(b, function (b, c, d) { return b || (c[B] || c[/^[a-z]+(?: +[a-z]+\b)*/i.exec(B)] || RegExp("\\b" + k(d) + "(?:\\b|\\w*\\d)", "i").exec(a)) && d }) }({
            ...
            w = function (b) {
                return l(b, function (b, c) {
                    ...
                    if (!b && (b = RegExp("\\b" + e + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(a))) {
                        ...
                        e && n && /^Win/i.test(g) && !/^Windows Phone /i.test(g) && (h = h[/[\d.]+$/.exec(g)]) && (g = "Windows " + h);
                        g = String(g);
                        e && n && (g = g.replace(RegExp(e, "i"), n));
        ...
        "IE" == v && /\blike iPhone OS\b/.test(a) ? (n = h(a.replace(/like iPhone OS/, "")), K = n.manufacturer, B = n.product) : /^iP/.test(B) ? (v || (v = "Safari"), w = "iOS" + ((n = / OS ([\d_]+)/i.exec(a)) ? " " + n[1].replace(/_/g, ".") : "")) : "Konqueror" != v || /buntu/i.test(w) ? K && "Google" != K && (/Chrome/.test(v) &&
        ...
        q || (q = f(["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", k(v), "(?:Firefox|Minefield|NetFront)"]));
        ...
        if (Q) {
            if (m(r, "global"))
                if (D && (n = D.lang.System, U = n.getProperty("os.arch"), w = w || n.getProperty("os.name") + " " + n.getProperty("os.version")), G) {
                    try { q = r.require("ringo/engine").version.join("."), v = "RingoJS" } catch (X) {
        ...
        if ("Fennec" == v || "Firefox" == v && /\b(?:Android|Firefox OS)\b/.test(w)) v = "Firefox Mobile";
            ...
            if ("IE" == v && Q) try {
                ...
                h.call(e, a.replace(x, "") + ";")) && n.name && (n = "ing as " + n.name + ((n = n.version) ? " " + n : ""), x.test(v) ? (/\bIE\b/.test(n) && "Mac OS" == w && (w = null), n = "identify" + n) : (n = "mask" + n, v = T ? d(T.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(n) && (w = null), Q || (q = null)), A = ["Presto"], t.push(n));
        else v += " Mobile";
        ...
        if (w) {
            ...
            w = { architecture: 32, family: n && !W ? w.replace(n[0], "") : w, version: n ? n[1] : null, toString: function () { var a = this.version; return this.family + (a && !W ? " " + a : "") + (64 == this.architecture ? " 64-bit" : "") } }
        ...
        r.ua = a;
        r.version = v && q;
        r.os = w || { architecture: null, family: null, version: null, toString: function () { return "null" } };
        r.parse = h;
        r.toString = function () { return this.description || "" };
    ...
    var q = u.hasOwnProperty,
        z = u.toString,
        y = h();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (c.platform = y, define(function () { return y })) : t &&
        b ? e(y, function (a, b) { t[b] = a }) : c.platform = y
}).call(this);

function buildIOSMeta() {
    for (var a = [{ name: "viewport", content: "width=device-width, height=device-height, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no" }, { name: "apple-mobile-web-app-capable", content: "yes" }, { name: "apple-mobile-web-app-status-bar-style", content: "black" }], f = 0; f < a.length; f++) {
        var d = document.createElement("meta");
        d.name = a[f].name;
        d.content = a[f].content;
...
function getSize(a) {
    ...
    if (void 0 === window["inner" + a]) a = e["client" + a];
        ...
        m.innerHTML = "<style>@media(" + f + ":" + e["client" + a] + "px){body#vpw-test-b div#vpw-test-d{" + f + ":7px!important}}</style>";
        g.appendChild(m);
        e.insertBefore(g, d.head);
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        var d = Math.min(a / CANVAS_HEIGHT, f / CANVAS_WIDTH),
            e = Math.round(CANVAS_WIDTH * d);
        d = Math.round(CANVAS_HEIGHT * d);
        if (d < a) {
            var g = a - d;
            d += g;
            e += CANVAS_WIDTH / CANVAS_HEIGHT * g
        } else e < f && (g = f - e, e += g, d += CANVAS_HEIGHT / CANVAS_WIDTH * g);
        g = a / 2 - d / 2;
        var m = f / 2 - e / 2,
            k = CANVAS_WIDTH / e;
        if (m * k < -EDGEBOARD_X || g * k < -EDGEBOARD_Y) d = Math.min(a / (CANVAS_HEIGHT -
            2 * EDGEBOARD_Y), f / (CANVAS_WIDTH - 2 * EDGEBOARD_X)), e = Math.round(CANVAS_WIDTH * d), d = Math.round(CANVAS_HEIGHT * d), g = (a - d) / 2, m = (f - e) / 2, k = CANVAS_WIDTH / e;
        s_iOffsetX = -1 * m * k;
        s_iOffsetY = -1 * g * k;
        0 <= g && (s_iOffsetY = 0);
        0 <= m && (s_iOffsetX = 0);
        ...
        s_bIsIphone ? (canvas = document.getElementById("canvas"), s_oStage.canvas.width = 2 * e, s_oStage.canvas.height = 2 * d, canvas.style.width = e + "px", canvas.style.height =
            d + "px", f = Math.min(e / CANVAS_WIDTH, d / CANVAS_HEIGHT), s_iScaleFactor = 2 * f, s_oStage.scaleX = s_oStage.scaleY = 2 * f) : s_bMobile && !1 === isIOS() ? ($("#canvas").css("width", e + "px"), $("#canvas").css("height", d + "px")) : (s_oStage.canvas.width = e, s_oStage.canvas.height = d, s_iScaleFactor = Math.min(e / CANVAS_WIDTH, d / CANVAS_HEIGHT), s_oStage.scaleX = s_oStage.scaleY = s_iScaleFactor);
        0 > g || (g = (a - d) / 2);
        $("#canvas").css("top", g + "px");
...
function createBitmap(a, f, d) {
    var e = new createjs.Bitmap(a),
        g = new createjs.Shape;
    f && d ? g.graphics.beginFill("#fff").drawRect(0, 0, f, d) : g.graphics.beginFill("#ff0").drawRect(0, 0, a.width, a.height);
    e.hitArea = g;
    return e
}

function createSprite(a, f, d, e, g, m) {
    a = null !== f ? new createjs.Sprite(a, f) : new createjs.Sprite(a);
    f = new createjs.Shape;
    f.graphics.beginFill("#000000").drawRect(-d, -e, g, m);
    a.hitArea = f;
    return a
}
...
function rotateVector2D(a, f) {
    var d = f.getX() * Math.cos(a) + f.getY() * Math.sin(a),
        e = f.getX() * -Math.sin(a) + f.getY() * Math.cos(a);
    f.set(d, e)
}
...
(function () {
    function a(a) {
        var e = { focus: "visible", focusin: "visible", pageshow: "visible", blur: "hidden", focusout: "hidden", pagehide: "hidden" };
        a = a || window.event;
        a.type in e ? document.body.className = e[a.type] : (document.body.className = this[f] ? "hidden" : "visible", "hidden" === document.body.className ? s_oMain.stopUpdate() : s_oMain.startUpdate())
    }
    var f = "hidden";
...
function CSpriteLibrary() {
    ...
    this.addSprite = function (e, g) {
        if (!a.hasOwnProperty(e)) {
            var b = new Image;
            a[e] = f[e] = { szPath: g, oSprite: b, bLoaded: !1 };
            d++
        }
    };
    ...
    this.loadSprites = function () {
        for (var a in f) f[a].oSprite.oSpriteLibrary = this, f[a].oSprite.szKey =
            a, f[a].oSprite.onload = function () {
                ...
                setTimeout(function () { f[b.szKey].oSprite.src = f[b.szKey].szPath }, 500)
...
var CANVAS_WIDTH = 1500,
    ...
    TIME_SHOW_WIN, TIME_SHOW_ALL_WINS, COIN_BET, MIN_BET, MAX_BET, TOTAL_MONEY, WIN_OCCURRENCE, SLOT_CASH, MIN_WIN, FREESPIN_OCCURRENCE, BONUS_OCCURRENCE, FREESPIN_SYMBOL_NUM_OCCURR, NUM_FREESPIN, BONUS_PRIZE, BONUS_PRIZE_OCCURR, PAYTABLE_VALUES,Userber=0,
    BONUS_FREESPIN = 1,
    BONUS_WHEEL = 2,
...
function CSlotSettings() {
    ...
    this._initSymbolSpriteSheets = function () {
        ...
        for (var a = 1; a < NUM_SYMBOLS + 1; a++) {
            var f = { images: [s_oSpriteLibrary.getSprite("symbol_" + a)], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], moving: [1, 2] } };
    ...
    this._initPaylines = function () {
        s_aPaylineCombo = [
            ...
            [{
                row: 0,
                col: 0
            }, { row: 0, col: 1 }, { row: 1, col: 2 }, { row: 2, col: 3 }, { row: 2, col: 4 }],
            ...
            [{
                row: 2,
                col: 0
            }, { row: 1, col: 1 }, { row: 2, col: 2 }, { row: 1, col: 3 }, { row: 2, col: 4 }],
    ...
    this.initSymbolWin = function (a) {
        ...
        for (var f = 0; f <
            ...
            var d = a[f].split(",");
            s_aSymbolWin[f] = [];
            for (var e = 0; e < d.length; e++) s_aSymbolWin[f][e] = parseFloat(d[e])
        }
    };
    this._initSymbolAnims = function () {
        s_aSymbolAnims = [];
        var a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_1_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        ...
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_3_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        s_aSymbolAnims[2] = new createjs.SpriteSheet(a);
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_4_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        s_aSymbolAnims[3] =
            new createjs.SpriteSheet(a);
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_5_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        s_aSymbolAnims[4] = new createjs.SpriteSheet(a);
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_6_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        ...
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_8_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
        ...
        a = { framerate: 20, images: [s_oSpriteLibrary.getSprite("symbol_10_anim")], frames: { width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0 }, animations: { "static": [0, 1], anim: [1, 14] } };
...
function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./games/game35/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./games/game35/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./games/game35/sprites/but_start.png");
    ...
    this.attachSprites = function () {
        ...
        h = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT /
            2, c, TEXT_PRELOADER_CONTINUE, "Arial", "#000", 40, b);
        ...
        b.addChild(m);
        createjs.Tween.get(m).to({ alpha: 0 }, 500).call(function () {
    ...
    this.refreshLoader = function (b) {
        d.text = b + "%";
        100 === b && (s_oMain._onRemovePreloader(), d.visible = !1,
            e.visible = !1);
        g.graphics.clear();
...
function CMain(a) {
    ...
    this.soundLoaded = function () {
        d++;
        m.refreshLoader(Math.floor(d / e * 100))
    };
    this._initSounds = function () {
        Howler.mute(!s_bAudioActive);
        s_aSoundsInfo = [];
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "press_but", loop: !1, volume: 1, ingamename: "press_but" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "win", loop: !1, volume: 1, ingamename: "win" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "reels", loop: !1, volume: 1, ingamename: "reels" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "reel_stop", loop: !1, volume: 1, ingamename: "reel_stop" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "game_over_bonus", loop: !1, volume: 1, ingamename: "game_over_bonus" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "reel_bonus", loop: !1, volume: 1, ingamename: "reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "start_reel_bonus", loop: !1, volume: 1, ingamename: "start_reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "win_bonus", loop: !1, volume: 1, ingamename: "win_bonus" });
        s_aSoundsInfo.push({ path: "./games/game35/sounds/", filename: "start_reel", loop: !1, volume: 1, ingamename: "start_reel" });
            ...
            s_aSounds[a.ingamename] = new Howl({
                ...
                onplayerror: function (a) {
                    for (var b = 0; b < s_aSoundsInfo.length; b++)
                        if (a === s_aSounds[s_aSoundsInfo[b].ingamename]._sounds[0]._id) { s_aSounds[s_aSoundsInfo[b].ingamename].once("unlock", function () { s_aSounds[s_aSoundsInfo[b].ingamename].play() }); break }
                }
            })
        }, b ? 200 : 0)
    };
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("but_bg", "./games/game35/sprites/but_play_bg.png");
        s_oSpriteLibrary.addSprite("but_exit", "./games/game35/sprites/but_exit.png");
        s_oSpriteLibrary.addSprite("bg_menu", "./games/game35/sprites/bg_menu.jpg");
        s_oSpriteLibrary.addSprite("bg_game", "./games/game35/sprites/bg_game.jpg");
        s_oSpriteLibrary.addSprite("paytable1", "./games/game35/sprites/paytable1.jpg");
        s_oSpriteLibrary.addSprite("paytable2", "./games/game35/sprites/paytable2.jpg");
        s_oSpriteLibrary.addSprite("paytable3", "./games/game35/sprites/paytable3.jpg");
        s_oSpriteLibrary.addSprite("mask_slot",
            "./games/game35/sprites/mask_slot.png");
        s_oSpriteLibrary.addSprite("spin_but", "./games/game35/sprites/but_spin_bg.png");
        s_oSpriteLibrary.addSprite("but_autospin", "./games/game35/sprites/but_autospin.png");
        s_oSpriteLibrary.addSprite("spin_bg", "./games/game35/sprites/spin_bg.png");
        s_oSpriteLibrary.addSprite("coin_but", "./games/game35/sprites/but_coin_bg.png");
        s_oSpriteLibrary.addSprite("info_but", "./games/game35/sprites/but_info_bg.png");
        s_oSpriteLibrary.addSprite("bet_but", "./games/game35/sprites/bet_but.png");
        s_oSpriteLibrary.addSprite("win_frame_anim", "./games/game35/sprites/win_frame_anim.png");
        s_oSpriteLibrary.addSprite("but_lines_bg",
            "./games/game35/sprites/but_lines_bg.png");
        s_oSpriteLibrary.addSprite("but_maxbet_bg", "./games/game35/sprites/but_maxbet_bg.png");
        s_oSpriteLibrary.addSprite("audio_icon", "./games/game35/sprites/audio_icon.png");
        s_oSpriteLibrary.addSprite("msg_box", "./games/game35/sprites/msg_box.png");
        s_oSpriteLibrary.addSprite("but_arrow_next", "./games/game35/sprites/but_arrow_next.png");
        s_oSpriteLibrary.addSprite("but_arrow_prev", "./games/game35/sprites/but_arrow_prev.png");
        s_oSpriteLibrary.addSprite("freespin_panel", "./games/game35/sprites/freespin_panel.png");
        s_oSpriteLibrary.addSprite("logo", "./games/game35/sprites/logo.png");
        s_oSpriteLibrary.addSprite("logo_freespin", "./games/game35/sprites/logo_freespin.png");
        s_oSpriteLibrary.addSprite("but_credits", "./games/game35/sprites/but_credits.png");
        s_oSpriteLibrary.addSprite("but_fullscreen", "./games/game35/sprites/but_fullscreen.png");
        s_oSpriteLibrary.addSprite("logo_ctl", "./games/game35/sprites/logo_ctl.png");
        for (var a = 1; a < NUM_SYMBOLS + 1; a++) s_oSpriteLibrary.addSprite("symbol_" + a, "./games/game35/sprites/symbol_" + a + ".png"), s_oSpriteLibrary.addSprite("symbol_" + a + "_anim", "./games/game35/sprites/symbol_" + a + "_anim.png");
        for (a = 1; a < NUM_PAYLINES + 1; a++) s_oSpriteLibrary.addSprite("payline_" +
            a, "./games/game35/sprites/payline_" + a + ".png");
        s_oSpriteLibrary.addSprite("bg_bonus", "./games/game35/sprites/bonus/bg_bonus.png");
        s_oSpriteLibrary.addSprite("but_spin_bonus", "./games/game35/sprites/bonus/but_spin_bonus.png");
        s_oSpriteLibrary.addSprite("leds", "./games/game35/sprites/bonus/leds.png");
        s_oSpriteLibrary.addSprite("wheel", "./games/game35/sprites/bonus/wheel.png");
...
function CTextButton(a, f, d, e, g, m, k, l) {
    ...
    this._init = function (a, e, d, g, f, r, k) {
        h = !1;
        b = 1;
        c = [];
        t = [];
        ...
        q.addChild(y, z);
        l.addChild(q);
        z = new CTLText(q, 10, 10, d.width - 20, d.height - 20, k, "center", r, f, 1, 5, 10, g, !0, !0, !0, !1);
    ...
    this.buttonRelease = function () {
        h || (q.scaleX = b, q.scaleY = b, c[ON_MOUSE_UP] && c[ON_MOUSE_UP].call(t[ON_MOUSE_UP],
            x))
    };
...
function CGfxButton(a, f, d, e) {
    ...
    this._initListener = function () {
        ...
        h = b.on("pressup", this.buttonRelease)
    };
    ...
    this.buttonRelease = function () {
        ...
        b.scaleX = 1;
        b.scaleY = 1;
        g[ON_MOUSE_UP] && g[ON_MOUSE_UP].call(m[ON_MOUSE_UP], k)
    };
    this.buttonDown = function () {
        b.scaleX = .9;
        b.scaleY = .9;
        g[ON_MOUSE_DOWN] && g[ON_MOUSE_DOWN].call(m[ON_MOUSE_DOWN], k)
    };
...
function CToggle(a, f, d, e, g) {
    ...
    this._init = function (a, b, c, e, d) {
        ...
        m = e;
        h = createSprite(d, "state_" + m, c.width / 2 / 2, c.height / 2, c.width / 2, c.height);
        h.x = a;
        h.y = b;
        h.stop();
    ...
    this._initListener = function () {
        b = h.on("mousedown", this.buttonDown);
        c = h.on("pressup", this.buttonRelease)
    };
    this.addEventListener = function (a, b, c) {
        k[a] = b;
        l[a] = c
    ...
    this.buttonRelease = function () {
        ...
        m = !m;
        h.gotoAndStop("state_" + m);
        k[ON_MOUSE_UP] && k[ON_MOUSE_UP].call(l[ON_MOUSE_UP], m)
    };
    this.buttonDown = function () {
        h.scaleX = .9;
        h.scaleY = .9;
...
function CBetBut(a, f, d) {
    ...
    this._init = function (a, b, c) {
        ...
        l = createSprite(d, "on", 0, 0, c.width / 2, c.height);
        l.stop();
        l.x = a;
        l.y = b;
        l.regX = c.width / 2;
...
function CMenu() {
    ...
    this._init = function () {
        ...
        SHOW_CREDITS ? (x = s_oSpriteLibrary.getSprite("but_credits"), a = x.height / 2 + 10, f = x.height / 2 + 10, h = new CGfxButton(a, f, x, s_oAttachSection), h.addEventListener(ON_MOUSE_UP, this._onButCreditsRelease, this), d = a + x.width, e = f) : (d = x.height / 2 + 10, e = x.height / 2 + 10);
        x = window.document;
        ...
        k && screenfull.isEnabled && (x = s_oSpriteLibrary.getSprite("but_fullscreen"), b = new CToggle(d, e, x, s_bFullscreen, s_oAttachSection), b.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
        r = new createjs.Shape;
        r.graphics.beginFill("black").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        s_oAttachSection.addChild(r);
        createjs.Tween.get(r).to({ alpha: 0 }, 400).call(function () { r.visible = !1 });
    ...
    this.unload = function () {
        ...
        k && screenfull.isEnabled && b.unload();
        s_oAttachSection.removeChild(c);
        c = null;
        s_oAttachSection.removeChild(r);
        s_oMenu = r = null
    };
    this.refreshButtonPos = function (c, r) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || u.setPosition(g - c, r + m);
        SHOW_CREDITS && h.setPosition(a + c, f + r);
        k && screenfull.isEnabled && b.setPosition(d + c, e + r)
    };
...
function CGame(a) {
    var f = !1,
        d = !1,
        e, g, m, k, l, h, b, c, t, u, r, x, q, z, y, H, I, L, C, J, E, P, F, R, G, D, M, S, p, N = null,
        O;
    this._init = function () {
        g = GAME_STATE_IDLE;
        I = l = m = 0;
        ...
        for (var a = 0; a < s_aSymbolWin.length; a++)
            for (var b = s_aSymbolWin[a], c = 0; c <
                b.length; c++) 0 !== b[c] && b[c] < MIN_WIN && (MIN_WIN = b[c]);
        O = new CBonusPanel;
        f = !0
    };
    this.unload = function () {
    ...
    this._initReels = function () {
        var a = REEL_OFFSET_X,
            ...
            c = 0;
        C = [];
        for (var e = 0; e < NUM_REELS; e++) C[e] = new CReelColumn(e, a, b, c), C[e + NUM_REELS] = new CReelColumn(e + NUM_REELS, a, b + SYMBOL_SIZE * NUM_ROWS, c), a += SYMBOL_SIZE +
        ...
        if (m > MIN_REEL_LOOPS)
            if (k === b) {
                if (!1 === C[a].isReadyToStop()) {
                    var c = a;
                    a < NUM_REELS ? (c += NUM_REELS, C[c].setReadyToStop(), C[a].restart([F[0][a], F[1][a],
                    F[2][a]
                    ], !0)) : (c -= NUM_REELS, C[c].setReadyToStop(), C[a].restart([F[0][c], F[1][c], F[2][c]], !0))
                }
            } else C[a].restart(this._generateRandSymbols(), !1);
        else C[a].restart(this._generateRandSymbols(), !1), d && 0 === a && m++
    };
    this.stopNextReel = function () {
        l++;
        0 === l % 2 && (playSound("reel_stop", 1, !1), k = P[l / 2], l === 2 * NUM_REELS && this._endReelAnimation())
    };
    this._endReelAnimation = function () {
        ...
        l = m = 0;
        k = P[0];
        0 < z && (p.disableSpin(e), p.disableGuiButtons(!1));
        !1 === M.visible && 0 === q || p.refreshFreeSpinNum(q);
        if (0 <
            E.length) {
            for (var a = 0; a < E.length; a++) { 0 < E[a].line && (N.highlightCombo(E[a].value - 1, E[a].num_win), p.showLine(E[a].line)); for (var c = E[a].list, f = 0; f < c.length; f++) J[c[f].row][c[f].col].show(c[f].value), C[c[f].col].setVisible(c[f].row, !1), C[c[f].col + NUM_REELS].setVisible(c[f].row, !1) }
            ...
            q ? (G.visible = !1, D.visible = !0, M.visible = !0, p.disableSpin(e), this.onSpin()) : (G.visible = !0, D.visible = !1, M.visible = !1, p.refreshFreeSpinNum(""), e ? r < u && 0 === q ? (this.resetCoinBet(), e = !1, p.enableGuiButtons()) : (p.enableAutoSpin(), this.onSpin()) : g = GAME_STATE_IDLE);
        r < u && 0 === q ? (this.resetCoinBet(), e = !1, p.enableGuiButtons()) : e || 0 !== q || 0 !== z || (p.enableGuiButtons(), p.disableBetBut(!1));
        L++;
    ...
    this._hideAllWins = function () {
        for (var a = 0; a < E.length; a++)
            for (var e = E[a].list, d = 0; d < e.length; d++) J[e[d].row][e[d].col].stopAnim(), C[e[d].col].setVisible(e[d].row, !0), C[e[d].col + NUM_REELS].setVisible(e[d].row, !0);
        p.hideAllLines();
        c = b = 0;
        b = TIME_SHOW_WIN;
    ...
    this.activateLines = function (a) {
        ...
        p.refreshTotalBet(u);
        p.refreshNumLines(h);
        a > r ? p.disableSpin(e) : p.enableSpin()
    };
    ...
    this.onMaxBet = function () {
        if (r < MAX_BET * NUM_PAYLINES) s_oMsgBox.show(TEXT_NO_MAX_BET);
            ...
            p.refreshTotalBet(u);
            p.refreshNumLines(h);
            a > r ? p.disableSpin(e) : (p.enableSpin(), this.onSpin())
        }
    };
...
function CReelColumn(a, f, d, e) {
    ...
    this._init = function (a, e, d, f) {
        ...
        l = a;
        b = f;
        h = l < NUM_REELS ? l : l - NUM_REELS;
        u = 0;
        r = MAX_FRAMES_REEL_EASE;
        t = REEL_STATE_START;
        x = d;
        q = x + SYMBOL_SIZE * NUM_ROWS;
        this.initContainer(e, d)
    };
    ...
    this._setSymbol = function (a) {
        ...
        for (var b = 0, c = 0; c < a.length; c++) {
            var e = new createjs.Sprite(s_aSymbolData[a[c]], "static", 0, 0, SYMBOL_SIZE, SYMBOL_SIZE);
            e.stop();
            e.x = 0;
            e.y = b;
            y.addChild(e);
    ...
    this.setVisible = function (a, b) { z[a].visible = b };
    ...
    this.isReadyToStop = function () { return m };
    ...
    this._updateStopping = function () {
        u++;
        if (u >= r) g = !1, u = 0, r = MAX_FRAMES_REEL_EASE, t = REEL_STATE_START, c = 0, m = !1, k && (k = !1, y.y = REEL_OFFSET_Y), s_oGame.stopNextReel();
        else {
    ...
    this.update = function () {
        ...
        if (!1 !==
            g && (c++, c > b)) switch (!1 === m && y.y > REEL_ARRIVAL_Y && s_oGame.reelArrived(l, h), t) {
...
function CInterface(a, f, d) {
    var e, g, m, k, l, h, b, c, t, u, r, x, q, z, y, H, I, L = null,
        C = null,
        J, E, P, F, R, G;
    this._init = function (a, d, f) {
        ...
        L && (p = s_oSpriteLibrary.getSprite("but_fullscreen"), I = new CToggle(m, k, p, s_bFullscreen, s_oAttachSection), I.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease,
            this));
        ...
        P = new CTLText(s_oAttachSection, 827, CANVAS_HEIGHT - 118, 174, 30, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, TEXT_BET + ": " + d.toFixed(2), !0, !0, !1, !1);
        ...
        f.addEventListenerWithParams(ON_MOUSE_UP,
        ...
        d += 44;
        f = new CBetBut(1130 + p.width / 2, d, p, !0);
        f.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked,
            this, 7);
        b[6] = f;
        d += 43;
        f = new CBetBut(1130 + p.width / 2, d, p, !0);
    ...
    this.refreshButtonPos =
        function (a, b) {
            t.setPosition(e - a, b + g);
            !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || z.setPosition(l - a, b + h);
            L && screenfull.isEnabled && I.setPosition(m - a, k + b)
        };
    this.refreshMoney = function (a) {
        $.post("update35", { _token: $('meta[name=csrf-token]').attr('content'), amount: a ,user_id:user_id}, function (t) {
    ...
    this.refreshNumLines = function (a) {
        F.refreshText(a);
        for (var d = 0; d < NUM_PAYLINES; d++) d < a ? (b[d].setOn(), c[d].visible = !0) : b[d].setOff();
    ...
    this._onAddLine = function () { s_oGame.addLine() };
    this._onInfo = function () { s_oGame.onInfoClicked() };
    this._onBet = function () { s_oGame.changeCoinBet() };
...
function CPayTablePanel() {
    ...
    this._init = function () {
        ...
        h.addChild(m);
        k = new CGfxButton(CANVAS_WIDTH - 300, 50, s_oSpriteLibrary.getSprite("but_arrow_next"), h);
        k.addEventListener(ON_MOUSE_UP, this._onNext, this);
        l = new CGfxButton(300, 50, s_oSpriteLibrary.getSprite("but_arrow_prev"), h);
        l.addEventListener(ON_MOUSE_UP, this._onPrev, this)
    };
    this.unload = function () {
        var a = this;
        m.off("click", function () { a._onExit() });
    ...
    this._createPayouts = function (a) {
        f = [];
        d = [];
        a = [{ x: 435, y: 158 }, { x: 765, y: 158 }, { x: 1087, y: 158 }, { x: 435, y: 340 }, { x: 765, y: 340 }, { x: 1087, y: 340 }, { x: 435, y: 524 }];
        for (var b = 0; b < s_aSymbolWin.length - 3; b++) {
            ...
            g.y = a[b].y;
            h.addChild(g);
            for (var k = 0, m = e.length - 1; 0 <= m; m--)
                if (0 !== e[m]) {
                    var l = new CTLText(g, 0, k, 50, 30, 125, "left", "#ffffff", FONT_GAME, 1, 2, 2, "X" + (m + 1), !0, !0, !0, !1);
                    k += l.getFontSize();
                    f[b][m] = l;
                    l =
                        new CTLText(g, 50, l.getY(), 50, 30, 125, "right", "#ffff00", FONT_GAME, 1, 2, 2, e[m], !0, !0, !0, !1);
                    d[b][m] = l
                }
        ...
        for (var a = 0; a < f.length; a++)
            for (var c = 0; c < f[a].length; c++) {
                var e =
                    ...
                    g = d[a][c];
                e && e.setColor("#ffffff");
                g && (d[a][c].setColor("#ffff00"), d[a][c].removeTweens(), d[a][c].setAlpha(1))
            }
    };
    ...
    this.tweenAlpha = function (a, c) {
        var b = this;
        createjs.Tween.get(a).to({ alpha: c }, 200).call(function () { 1 === c ? b.tweenAlpha(a, 0) : b.tweenAlpha(a, 1) })
    };
...
function CStaticSymbolCell(a, f, d, e) {
    ...
    this._init = function (a, c, d, e) {
        ...
        h.visible = !1;
        k = [];
        for (a = 0; a < NUM_SYMBOLS; a++) c = createSprite(s_aSymbolAnims[a], "static", 0, 0, SYMBOL_SIZE, SYMBOL_SIZE), c.stop(), c.x = d, c.y = e, c.on("animationend", this._onAnimEnded, null, !1, { index: a }), h.addChild(c), k[a] = c, k[a].visible = !1;
        a = {
            framerate: 60,
    ...
    this.show = function (a) {
        ...
        g = a - 1;
        m = k[a - 1].spriteSheet.getNumFrames();
        h.visible = !0
    };
...
function CTweenController() {
    this.tweenValue = function (a, f, d) { return a + d * (f - a) };
    this.easeLinear = function (a, f, d, e) { return d * a / e + f };
    this.easeInCubic = function (a, f, d, e) { e = (a /= e) * a * a; return f + d * e };
    this.easeBackInQuart = function (a, f, d, e) { e = (a /= e) * a; return f + d * (2 * e * e + 2 * e * a + -3 * e) };
    this.easeInBack = function (a, f, d, e) { return d * (a /= e) * a * (2.70158 * a - 1.70158) + f };
...
function CMsgBox() {
    ...
    this._init = function () {
        ...
        g.addChild(a);
        d = new CTLText(g, CANVAS_WIDTH / 2 - 298, CANVAS_HEIGHT / 2 - 118, 600, 150, 40, "center", "#000", FONT_GAME, 1, 0, 0, " ", !0, !0, !0, !1);
        f = new CTLText(g, CANVAS_WIDTH / 2 - 300, CANVAS_HEIGHT / 2 - 120, 600, 150, 40, "center", "#fff", FONT_GAME, 1, 0, 0, " ", !0, !0, !0, !1);
        e = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT - 200, s_oSpriteLibrary.getSprite("but_bg"), TEXT_OK,
...
function CWheelBonus(a, f, d) {
    ...
    this._initColors = function () {
        ...
        for (var c = 0; 4 > c; c++)
            for (a =
                9 + c * SEGMENT_ROT * 5; a < 27 + c * SEGMENT_ROT * 5; a++) g[a] = "blue";
        for (c = 0; 4 > c; c++)
            for (a = 27 + c * SEGMENT_ROT * 5; a < 45 + c * SEGMENT_ROT * 5; a++) g[a] = "green";
        for (c = 0; 4 > c; c++)
            for (a = 45 + c * SEGMENT_ROT * 5; a < 63 + c * SEGMENT_ROT * 5; a++) g[a] = "yellow";
        for (c = 0; 4 > c; c++)
            for (a = 63 + c * SEGMENT_ROT * 5; a < 81 + c * SEGMENT_ROT * 5; a++) g[a] = "red";
        for (c = 0; 3 > c; c++)
            for (a = 81 + c * SEGMENT_ROT * 5; a <= 99 + c * SEGMENT_ROT * 5; a++) g[a] = "violet";
    ...
    this.spin = function (a, c) {
        ...
        createjs.Tween.get(l).to({ rotation: l.rotation + a }, WHEEL_SPIN_TIMESPEED * c, createjs.Ease.quartOut).call(function () {
            l.rotation %= 360;
...
function CBonusPanel() {
    ...
    this._onSpin = function () {
        ...
        var a = MIN_FAKE_SPIN + Math.floor(3 * Math.random()),
            b = SEGMENT_ROT - 3;
        b = -b / 2 + Math.random() * b;
        b = (360 - h.getDegree() + m * SEGMENT_ROT + b) % 360;
        h.spin(360 * a + b, a)
    };
    this._animLedIdle = function () {
        ...
        if (d > TIME_ANIM_IDLE) {
            d = 0;
            for (var a = Math.floor(Math.random() * b.getNumAnim()); a === f;) a = Math.floor(Math.random() * b.getNumAnim());
            b.changeAnim(a);
            f = a
        }
    };
    ...
    this._animLedWin = function () {
        0 === e ? (b.changeAnim(4 + Math.round(Math.random())), b.setWinColor(this.getCurColor())) : e > TIME_ANIM_WIN && (d = TIME_ANIM_IDLE, g = STATE_BONUS_IDLE,
            s_oBonusPanel.unload(), e = 0);
        e += s_iTimeElaps
    };
    this._animLedLose = function () {
        0 === e ? (b.changeAnim(6), b.setWinColor(this.getCurColor())) : e > TIME_ANIM_LOSE && (d = TIME_ANIM_IDLE, g = STATE_BONUS_IDLE, s_oBonusPanel.unload(), e = 0);
        e += s_iTimeElaps
    };
    ...
    this._animWinText =
        function () {
            k = 1 === k ? 0 : 1;
            createjs.Tween.get(t.getText()).to({ alpha: k }, 150, createjs.Ease.cubicOut).call(function () { s_oBonusPanel._animWinText() })
        };
    this.unload = function () {
        a = !1;
        u.visible = !1;
...
function CLedsBonus(a, f, d) {
    ...
    this._init = function (a, b) {
        ...
        t.y = b;
        u.addChild(t);
        var d = { images: [s_oSpriteLibrary.getSprite("leds")], frames: { width: 54, height: 54, regX: 27, regY: 27 }, animations: { off: [0], white: [1], green: [2], blue: [3], violet: [4], red: [5], yellow: [6] } };
        d = new createjs.SpriteSheet(d);
        for (var e = new CVector2(-255, 0), f = 360 / WHEEL_SETTINGS.length * Math.PI / 180, g = 0; g < WHEEL_SETTINGS.length; g++) c[g] = createSprite(d, "off",
            0, 0, 54, 54), c[g].x = e.getX(), c[g].y = e.getY(), rotateVector2D(f, e), t.addChild(c[g]);
        c[0].visible = !1
    };
    ...
    this.changeAnim = function (a) {
        k = 0;
        m = a;
        for (a = 0; a < c.length; a++) c[a].gotoAndStop("off")
    };
    this.animIdle0 = function () {
        k += s_iTimeElaps;
        if (0 <= k && k < ANIM_IDLE1_TIMESPEED / 2)
            for (var a = 0; a < c.length; a++) 0 === a % 2 ? c[a].gotoAndStop("white") : c[a].gotoAndStop("off");
        else if (k >= ANIM_IDLE1_TIMESPEED /
            2 && k < ANIM_IDLE1_TIMESPEED)
            for (a = 0; a < c.length; a++) 0 === a % 2 ? c[a].gotoAndStop("off") : c[a].gotoAndStop("white");
        else k = 0
    };
    this.animIdle1 = function () {
        0 === k && (h = 0, c[h].gotoAndStop("white"), c[c.length / 4].gotoAndStop("white"), c[c.length / 2].gotoAndStop("white"), c[3 * c.length / 4].gotoAndStop("white"));
        k += s_iTimeElaps;
        k > ANIM_IDLE2_TIMESPEED && (h === c.length / 4 && (h = 0, k = 1), 0 === h ? (c[c.length - 1].gotoAndStop("off"), c[0].gotoAndStop("white"), c[c.length / 4 - 1].gotoAndStop("off"), c[c.length / 4].gotoAndStop("white"), c[c.length /
    ...
    this.animIdle2 = function () {
        0 === k && (h = 0, b = c.length / 2, c[h].gotoAndStop("white"),
            c[b].gotoAndStop("white"));
        k += s_iTimeElaps;
        k > ANIM_IDLE3_TIMESPEED && (h === c.length / 2 && (h = 0, b = c.length / 2, k = 1), 0 === h ? (c[c.length - 1].gotoAndStop("off"), c[1].gotoAndStop("off"), c[0].gotoAndStop("white"), c[c.length / 2 + 1].gotoAndStop("off"), c[c.length / 2 - 1].gotoAndStop("off"), c[c.length / 2].gotoAndStop("white")) : (c[h - 1].gotoAndStop("off"), c[h].gotoAndStop("white"), 1 !== h && c[c.length - h + 1].gotoAndStop("off"), c[c.length - h].gotoAndStop("white"), c[b + 1].gotoAndStop("off"), c[b].gotoAndStop("white"), c[c.length - b - 1].gotoAndStop("off"),
            0 !== b && c[c.length - b].gotoAndStop("white")), h++, b--, k = 1)
    };
    this.animSpin0 = function () {
        0 === k && (h = Math.floor(Math.random() * c.length), c[h].gotoAndStop("white"));
        k += s_iTimeElaps;
        k > ANIM_SPIN_TIMESPEED && (0 > h && (h = c.length - 1, k = 1), h === c.length - 1 ? (c[0].gotoAndStop("off"), c[c.length - 1].gotoAndStop("white")) : (c[h + 1].gotoAndStop("off"), c[h].gotoAndStop("white")), h--, k = 1)
    };
    this.animWin0 = function () {
        k += s_iTimeElaps;
        if (0 <= k && k < ANIM_WIN1_TIMESPEED / 2)
            for (var a = 0; a < c.length; a++) 0 === a % 2 ? c[a].gotoAndStop(e) : c[a].gotoAndStop("off");
        else if (k >= ANIM_WIN1_TIMESPEED / 2 && k < ANIM_WIN1_TIMESPEED)
            for (a = 0; a < c.length; a++) 0 === a % 2 ? c[a].gotoAndStop("off") : c[a].gotoAndStop(e);
        else k = 0
    };
    this.animWin1 = function () {
        0 === k && (h = 0, b = c.length / 2, g = e, c[h].gotoAndStop(g), c[b].gotoAndStop(g));
        k += s_iTimeElaps;
        k > ANIM_WIN2_TIMESPEED && (h > c.length / 4 && (h = 0, b = c.length / 2, k = 1, g = g === e ? "off" : e), 0 === h ? (c[0].gotoAndStop(g), c[c.length / 2].gotoAndStop(g)) : h <= c.length / 4 && (c[h].gotoAndStop(g), c[c.length - h].gotoAndStop(g), c[b].gotoAndStop(g), 0 !== b && c[c.length - b].gotoAndStop(g)),
            h++, b--, k = 1)
    };
    this.animLose = function () {
        for (var a = 0; a < c.length; a++) c[a].gotoAndStop(e);
        m = -1
    };
    this.update = function () {
        switch (m) {
...
function _setMinWin() {
    ...
    for (var a = 0; a < _aSymbolWin.length; a++)
        for (var f = _aSymbolWin[a], d = 0; d < f.length; d++) 0 !== f[d] && f[d] < s_aSession.min_win && (s_aSession.min_win = f[d])
}
...
function _onSpin(a, f, d) {
    ...
    if (d > s_aSession.iMoney) _dieError("INVALID BET: " + d + ",money:" + s_aSession.iMoney);
        ...
        $(s_oMain).trigger("bet_placed", { bet: f, tot_bet: d });
        Userber=d;
        console.log(d);
        s_aSession.iMoney -= d;
        s_aSession.iSlotCash += d;
        var e = s_aSession.bBonus = 0,
            g = 0;
        if (s_aSession.iSlotCash < s_aSession.min_win * f) return generLosingPattern(), 1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0)), "res=true&win=false&pattern=" + JSON.stringify(_aFinalSymbols) +
        ...
        if (Math.floor(100 * Math.random()) < s_aSession.win_occurrence) {
            if (0 === s_aSession.bFreeSpin && 0 === s_aSession.bBonus) {
                ...
                0 === s_aSession.iTotFreeSpin && m < s_aSession.freespin_occurrence + s_aSession.bonus_occurrence && (m = Math.floor(Math.random() * (s_aSession.freespin_occurrence + s_aSession.bonus_occurrence) + 1), m <= s_aSession.freespin_occurrence ? e =
                    1 : g = s_aSession.iSlotCash >= s_aSession.bonus_prize[0] * f ? 1 : 0)
            }
            var k;
            m = 0;
            do {
                generateRandomSymbols(e, g);
                var l = checkWin(e, g, a),
                    h = 0;
                for (k = 0; k < l.length; k++) h += l[k].amount;
                h *= f;
                var b = 0;
                k = -1;
                if (1 === g) {
                    ...
                    for (b = 0; b < s_aSession.bonus_prize_occur.length; b++)
                        for (var c = s_aSession.bonus_prize_occur[b], t = 0; t < c; t++) k.push(b);
                    k = k[Math.floor(Math.random() * k.length)];
                    b = s_aSession.bonus_prize[k] * f
                }
                m++
            } while (0 === l.length || b + h > s_aSession.iSlotCash || b + h < d);
            //console.log('i think here ',s_aSession.iMoney,h,b)
            s_aSession.iMoney = s_aSession.iMoney + 0 + 0;
            $.post("update35", { _token: $('meta[name=csrf-token]').attr('content'), amount: s_aSession.iMoney + h + b,bet:Userber,user_id:user_id }, function (t) {
            
            });
            s_aSession.iMoney = s_aSession.iMoney + 0 + Userber;
            console.log('s_aSession.coin_bet',Userber);
            s_aSession.iSlotCash =
                s_aSession.iSlotCash - h - b;
            1 === e && 2 < _iNumSymbolFreeSpin ? (s_aSession.bFreeSpin = 1, s_aSession.iTotFreeSpin = s_aSession.num_freespin[_iNumSymbolFreeSpin - 3]) : 1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0));
            return "res=true&win=true&pattern=" + JSON.stringify(_aFinalSymbols) + "&win_lines=" + JSON.stringify(l) + "&money=" + s_aSession.iMoney + "&tot_win=" + h + "&freespin=" + s_aSession.iTotFreeSpin + "&bonus=" + s_aSession.bBonus + "&bonus_prize=" +
...
function _initPaylines() {
    ...
    _aPaylineCombo[5] = [{
        row: 1,
        col: 0
    }, { row: 0, col: 1 }, { row: 0, col: 2 }, { row: 0, col: 3 }, { row: 1, col: 4 }];
    ...
    _aPaylineCombo[10] = [{ row: 2, col: 0 }, { row: 0, col: 1 }, { row: 1, col: 2 }, { row: 2, col: 3 }, {
        row: 1,
        col: 4
    }];
    ...
    _aPaylineCombo[16] = [{ row: 1, col: 0 }, {
        row: 1,
        col: 1
    }, { row: 2, col: 2 }, { row: 1, col: 3 }, { row: 1, col: 4 }];
...
function generLosingPattern() {
    for (var a = [], f = 0; f < NUM_ROWS; f++) {
        do var d = Math.floor(Math.random() * _aRandSymbols.length); while (9 === _aRandSymbols[d] || 10 === _aRandSymbols[d] || 8 === _aRandSymbols[d]);
        d = _aRandSymbols[d];
        a[f] = d
    }
    for (f = 0; f < NUM_ROWS; f++) {
        _aFinalSymbols[f] = [];
        for (var e = 0; e < NUM_REELS; e++)
            if (0 == e) _aFinalSymbols[f][e] = a[f];
            else {
                do d = Math.floor(Math.random() * _aRandSymbols.length), d = _aRandSymbols[d]; while (a[0] === d || a[1] === d || a[2] === d || 9 === d || 10 === d || 8 === d);
                _aFinalSymbols[f][e] = d
            }
    }
}
...
function generateRandomSymbols(a, f) {
    ...
    if (1 === a) {
        var g = [];
        for (d = 0; d < s_aSession.freespin_symbol_num_occur.length; d++)
            for (e = 0; e < s_aSession.freespin_symbol_num_occur[d]; e++) g.push(d);
        ...
        for (e = 0; e < m; e++) g = Math.floor(3 * Math.random()), _aFinalSymbols[g][d[e]] = 9
    }
}
...
function checkWin(a, f, d) {
    for (var e = [], g = 0; g < d; g++) {
        var m = _aPaylineCombo[g],
            ...
            h = 1,
            b = 1;
        for (k.push({ row: m[0].row, col: m[0].col, value: _aFinalSymbols[m[0].row][m[0].col] }); 8 === l && b < NUM_REELS;) h++, l = _aFinalSymbols[m[b].row][m[b].col], k.push({ row: m[b].row, col: m[b].col, value: _aFinalSymbols[m[b].row][m[b].col] }), b++;
        for (; b < m.length; b++)
            if (_aFinalSymbols[m[b].row][m[b].col] === l || 8 === _aFinalSymbols[m[b].row][m[b].col]) h++, k.push({ row: m[b].row, col: m[b].col, value: _aFinalSymbols[m[b].row][m[b].col] });
            else break;
        0 < _aSymbolWin[l - 1][h - 1] && e.push({ line: g + 1, amount: _aSymbolWin[l - 1][h - 1], num_win: h, value: l, list: k })
    }
    if (1 === a) {
        k = [];
        for (a = 0; a < NUM_ROWS; a++)
            for (f = 0; f < NUM_REELS; f++) 10 === _aFinalSymbols[a][f] && k.push({ row: a, col: f, value: 10 });
        e.push({ line: 0, amount: 0, num_win: k.length, value: 10, list: k })
    } else if (1 === f) {
        k = [];
        for (a = 0; a < NUM_ROWS; a++)
            for (f = 0; f < NUM_REELS; f++) 9 === _aFinalSymbols[a][f] && k.push({ row: a, col: f, value: 9 });
        e.push({ line: 0, amount: 0, num_win: k.length, value: 9, list: k })
    }
    return e
}

function shuffle(a) { for (var f, d, e = a.length; e; f = Math.floor(Math.random() * e), d = a[--e], a[e] = a[f], a[f] = d); return a }

function _dieError(a) { return "res=false&desc=" + a }
...
function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        d.y = CANVAS_HEIGHT / 2;
        b.addChild(d);
        h = new createjs.Text("www.codethislab.com", "34px " + FONT_GAME, "#000");
        h.textAlign = "center";
        ...
        l.y = 385;
        b.addChild(l);
        createjs.Tween.get(b).to({ alpha: 1 }, 600, createjs.Ease.cubicOut);
        this.refreshButtonPos(s_iOffsetX, s_iOffsetY)
    };
...
CTLText.prototype = {
    ...
    setShadow: function (a, f, d, e) { null !== this._oText && (this._oText.shadow = new createjs.Shadow(a, f, d, e)) },
    ...
    getString: function () { return this._oText.text },
...
function CTLText(a, f, d, e, g, m, k, l, h, b, c, t, u, r, x, q, z) {
    this._oContainer = a;
    this._x = f;
    this._y = d;
    this._iWidth = e;
