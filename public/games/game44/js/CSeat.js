function CSeat() {
    ...
    this.showWin = function(iWin) {
        //console.log(iWin,_iCurBet,'showWin');
       if(iWin>0){
        $.post("update44", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iCredit + iWin, type: '0',bet:_iCurBet,user_id:user_id }, function(t) {
