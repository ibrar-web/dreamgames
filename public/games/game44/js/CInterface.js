function CInterface() {
    ...
    this.setMoney = function(iMoney, val) {
       // console.log('bet setMoney', iMoney, 'val', val);
        $.post("update44", { _token: $('meta[name=csrf-token]').attr('content'), amount: iMoney, type: val,user_id:user_id }, function(t) {
            _oMoneyAmountText.text = t;
        });
    ...
    this.refreshMoney = function(iStartMoney, iMoney) {
        //console.log('reward', iMoney,'refreshMoney');
        // $.post("update44", { _token: $('meta[name=csrf-token]').attr('content'), amount: iMoney, type: '0' }, function(t) {
