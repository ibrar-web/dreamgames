function CGame(oData){
    ...
    this._resetScratchCard = function(){
        ...
        s_iCurCredit += 0;
      //  console.log(_iCurBet,_iTotalWin);
     
        if(_iTotalWin>0){
            _oInterface.refreshCredit(s_iCurCredit+_iCurBet,1);
            $.post("update27", { _token: $('meta[name=csrf-token]').attr('content'), amount: s_iCurCredit+_iTotalWin,bet:_iCurBet,user_id:user_id }, function(t) {
            });
            s_iCurCredit += 0;
    ...
    this.startPlay = function(){
        ...
        _oInterface.refreshCredit(s_iCurCredit,2);
