...
function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./games/game50/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./games/game50/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./games/game50/sprites/but_start.png");
    ...
    this.attachSprites = function () {
        ...
        b.addChild(g);
        e.mask = g;
        d = new createjs.Text("", "30px " + FONT_GAME, "#c3b47c");
...
function CMain(a) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "bg_music", loop: 1, volume: 1, ingamename: "bg_music" });

        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "press_but", loop: !1, volume: 1, ingamename: "press_but" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "win", loop: !1, volume: 1, ingamename: "win" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "reels", loop: !1, volume: 1, ingamename: "reels" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "reel_stop", loop: !1, volume: 1, ingamename: "reel_stop" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "game_over_bonus", loop: !1, volume: 1, ingamename: "game_over_bonus" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "reel_bonus", loop: !1, volume: 1, ingamename: "reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "start_reel_bonus", loop: !1, volume: 1, ingamename: "start_reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "win_bonus", loop: !1, volume: 1, ingamename: "win_bonus" });
        s_aSoundsInfo.push({ path: "./games/game50/sounds/", filename: "start_reel", loop: !1, volume: 1, ingamename: "start_reel" });
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this);
        s_oSpriteLibrary.addSprite("but_bg", "./games/game50/sprites/but_play_bg.png");
        s_oSpriteLibrary.addSprite("but_exit", "./games/game50/sprites/but_exit.png");
        s_oSpriteLibrary.addSprite("bg_menu", "./games/game50/sprites/bg_menu.jpg");
        s_oSpriteLibrary.addSprite("paytable1", "./games/game50/sprites/paytable1.jpg");
        s_oSpriteLibrary.addSprite("paytable2", "./games/game50/sprites/paytable2.jpg");
        s_oSpriteLibrary.addSprite("paytable3", "./games/game50/sprites/paytable3.jpg");
        s_oSpriteLibrary.addSprite("mask_slot", "./games/game50/sprites/mask_slot.png");
        s_oSpriteLibrary.addSprite("spin_but", "./games/game50/sprites/but_spin_bg.png");
        s_oSpriteLibrary.addSprite("bg_game", "./games/game50/sprites/bg_game.jpg");

        s_oSpriteLibrary.addSprite("but_autospin", "./games/game50/sprites/but_autospin.png");
        s_oSpriteLibrary.addSprite("spin_bg", "./games/game50/sprites/spin_bg.png");
        s_oSpriteLibrary.addSprite("coin_but", "./games/game50/sprites/but_coin_bg.png");
        s_oSpriteLibrary.addSprite("info_but", "./games/game50/sprites/but_info_bg.png");
        s_oSpriteLibrary.addSprite("bet_but", "./games/game50/sprites/bet_but.png");
        s_oSpriteLibrary.addSprite("win_frame_anim", "./games/game50/sprites/win_frame_anim.png");
        s_oSpriteLibrary.addSprite("but_lines_bg", "./games/game50/sprites/but_lines_bg.png");
        s_oSpriteLibrary.addSprite("but_maxbet_bg", "./games/game50/sprites/but_maxbet_bg.png");
        s_oSpriteLibrary.addSprite("audio_icon", "./games/game50/sprites/audio_icon.png");
        s_oSpriteLibrary.addSprite("msg_box", "./games/game50/sprites/msg_box.png");
        s_oSpriteLibrary.addSprite("but_arrow_next", "./games/game50/sprites/but_arrow_next.png");
        s_oSpriteLibrary.addSprite("but_arrow_prev", "./games/game50/sprites/but_arrow_prev.png");
        s_oSpriteLibrary.addSprite("freespin_panel", "./games/game50/sprites/freespin_panel.png");
        s_oSpriteLibrary.addSprite("logo", "./games/game50/sprites/logo.png");
        s_oSpriteLibrary.addSprite("logo_freespin", "./games/game50/sprites/logo_freespin.png");
        s_oSpriteLibrary.addSprite("but_credits", "./games/game50/sprites/but_credits.png");
        s_oSpriteLibrary.addSprite("but_fullscreen", "./games/game50/sprites/but_fullscreen.png");
        s_oSpriteLibrary.addSprite("logo_ctl", "./games/game50/sprites/logo_ctl.png");
        for (var a = 1; a < NUM_SYMBOLS + 1; a++)
            s_oSpriteLibrary.addSprite("symbol_" + a, "./games/game50/sprites/symbol_" + a + ".png"),
                s_oSpriteLibrary.addSprite("symbol_" + a + "_anim", "./games/game50/sprites/symbol_" + a + "_anim.png");
        for (a = 1; a < NUM_PAYLINES + 1; a++)
            s_oSpriteLibrary.addSprite("payline_" + a, "./games/game50/sprites/payline_" + a + ".png");

        s_oSpriteLibrary.addSprite("bg_bonus", "./games/game50/sprites/bonus/bg_bonus.png");

        s_oSpriteLibrary.addSprite("bonus", "./games/game50/sprites/bonus.png"); /*88888888*/

        s_oSpriteLibrary.addSprite("but_spin_bonus", "./games/game50/sprites/bonus/but_spin_bonus.png");
        s_oSpriteLibrary.addSprite("leds", "./games/game50/sprites/bonus/leds.png");
        s_oSpriteLibrary.addSprite("wheel", "./games/game50/sprites/bonus/wheel.png");
    ...
    this._init = function () {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
            x = s_oSpriteLibrary.getSprite("audio_icon"),
                g = CANVAS_WIDTH - x.width / 4 - 10, m = x.height / 2 + 10,
                u = new CToggle(g, m, x, s_bAudioActive, s_oAttachSection),
                u.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        SHOW_CREDITS ? (x = s_oSpriteLibrary.getSprite("but_credits"), a = x.height / 2 + 10, f = x.height / 2 + 10, h = new CGfxButton(a, f, x, s_oAttachSection), h.addEventListener(ON_MOUSE_UP, this._onButCreditsRelease, this), d = a + x.width, e = f) : (d = x.height / 2 + 10, e = x.height / 2 + 10); x = window.document; var q = x.documentElement; k = q.requestFullscreen || q.mozRequestFullScreen || q.webkitRequestFullScreen || q.msRequestFullscreen; l = x.exitFullscreen || x.mozCancelFullScreen ||
...
function CInterface(a, f, d) {
    ...
    this._init = function (a, d, f) {
        ...
        r = new CTextButton(637 + p.width / 2, 564, p, TEXT_AUTOSPIN, FONT_GAME, "#063744", 35, s_oAttachSection);

        r.addEventListener(ON_MOUSE_UP, this._onAutoSpin, this);
        p = s_oSpriteLibrary.getSprite("spin_but");
        u = new CTextButton(724 + p.width / 2, 561, p, TEXT_SPIN, FONT_GAME, "#ffffff", 26, s_oAttachSection);
        u.addEventListener(ON_MOUSE_UP, this._onSpin, this);
        p = s_oSpriteLibrary.getSprite("info_but");
        x = new CTextButton(270 + p.width / 2, 575, p, TEXT_INFO, FONT_GAME, "#ffffff", 30, s_oAttachSection);
        x.addEventListener(ON_MOUSE_UP, this._onInfo, this);
        p = s_oSpriteLibrary.getSprite("but_lines_bg");
        q = new CTextButton(3 + p.width / 2, 576, p, TEXT_LINES, FONT_GAME, "#ffffff", 30, s_oAttachSection);
        q.addEventListener(ON_MOUSE_UP, this._onAddLine, this);
        p = s_oSpriteLibrary.getSprite("coin_but");
        y = new CTextButton(388 + p.width / 2, 576, p, TEXT_COIN, FONT_GAME, "#ffffff", 30, s_oAttachSection);
        y.addEventListener(ON_MOUSE_UP, this._onBet, this);
        p = s_oSpriteLibrary.getSprite("but_maxbet_bg");
        H = new CTextButton(787 + p.width / 2, 564, p, TEXT_MAX_BET, FONT_GAME, "#063744", 35, s_oAttachSection);
        H.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);
        E = new CTLText(s_oAttachSection, 1100, 540, 128, 50, 24, "center", "#c3b47c", FONT_GAME, 1, 0, 0, TEXT_MONEY + "\n" + f.toFixed(2) + TEXT_CURRENCY, !0, !0, !0, !1);
        F = new CTLText(s_oAttachSection, 279, CANVAS_HEIGHT - 70, 134, 12, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, NUM_PAYLINES, !0, !0, !1, !1);
        // F.setShadow("#000", 1, 1, 2); 
        J = new CTLText(s_oAttachSection, 367, CANVAS_HEIGHT - 70, 134, 15, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, a.toFixed(2), !0, !0, !1, !1);
        // J.setShadow("#000", 1, 1, 2); 
        P = new CTLText(s_oAttachSection, 457, CANVAS_HEIGHT - 70, 174, 15, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, TEXT_BET + d.toFixed(2), !0, !0, !1, !1);
        // P.setShadow("#000", 1, 1, 2); 
        R = new CTLText(s_oAttachSection, 905, CANVAS_HEIGHT - 74, 134, 23, 30, "center", "#c3b47c", FONT_GAME, 1, 0, 0, " ", !0, !0, !1, !1);
        // R.setShadow("#000", 1, 1, 2); 



        //free spin value
        G = new createjs.Text("", "30px " + FONT_GAME, "#063744");
        G.x = 752; G.y = 625;
        G.textAlign = "center";
    ...
    this.refreshMoney = function (a) {
        $.post("update50", { _token: $('meta[name=csrf-token]').attr('content'), amount: a, user_id: user_id }, function (t) {
...
function CPayTablePanel() {
    ...
    this._createPayouts = function (a) {
        f = []; d = [];
        a = [{ x: 510, y: 182 }, { x: 755, y: 182 }, { x: 1010, y: 182 }, { x: 510, y: 325 }, { x: 755, y: 325 }, { x: 1010, y: 325 }, { x: 510, y: 454 }];
...
function CWheelBonus(a, f, d) {
    ...
    this.setText = function (a) {
        for (var b = new CVector2(-150, 3), d = SEGMENT_ROT, f = Math.PI * SEGMENT_ROT / 180, g = 0; g < m.length; g++)
            e[g] = new CFormatText(b.getX(), b.getY(), "x" + m[g] * a, l), e[g].rotateText(-d * g), rotateVector2D(f, b)
    };
...
function CBonusPanel() {
    ...
    this._init = function () {
        ...
        h = new CWheelBonus(745, 330, u);
        var r = createBitmap(s_oSpriteLibrary.getSprite("bg_bonus"));
        u.addChild(r);
        b = new CLedsBonus(745, 325, u);
        f = b.getState();
        r = s_oSpriteLibrary.getSprite("but_spin_bonus");
        c = new CTextButton(690 + r.width / 2, 330, r, TEXT_SPIN, FONT_GAME, "#ffffff", 40, u);
        ...
        t = new CTLText(u, 680, 130, 102, 400, 76, "center", "#e9b3ff", FONT_GAME, 1, 0, 0, TEXT_CURRENCY + "0", !0, !0, !1, !1);
        t.setAlpha(k)
    };
    ...
    this._animWinText =
        function () {
            createjs.Tween.get(t.getText()).to({ scaleX: 3, scaleY: 3 }, 2500, createjs.Ease.quadOut).wait(1000).call(function () { s_oBonusPanel._animWinText() })
        };
    this.unload = function () { a = !1; u.visible = !1; createjs.Tween.removeTweens(t.getText()); s_oGame.exitFromBonus() };
    this.update = function () {
        if (a)
            switch (b.update(), g) {
                case STATE_BONUS_IDLE: this._animLedIdle();
                    break;
                case STATE_BONUS_SPIN: this._animLedSpin();
                    break;
                case STATE_BONUS_WIN: this._animLedWin();
                    break;
                case STATE_BONUS_LOSE: this._animLedLose();
            }
    };
    s_oBonusPanel = this;
    this._init()
...
function CLedsBonus(a, f, d) {
    ...
    this._init = function (a, b) {
        ...
        for (var e = new CVector2(-200, 0), f = 360 / WHEEL_SETTINGS.length * Math.PI / 180, g = 0; g < WHEEL_SETTINGS.length; g++)
            c[g] = createSprite(d, "off", 0, 0, 54, 54), c[g].x = e.getX(), c[g].y = e.getY(), rotateVector2D(f, e), t.addChild(c[g]);
        c[0].visible = !1
    };
...
function _onSpin(a, f, d) {
    if (d > s_aSession.iMoney) _dieError("INVALID BET: " + d + ",money:" + s_aSession.iMoney);
        ...
        s_aSession.iMoney -= d; s_aSession.iSlotCash += d; 
        userbet = d;
        var e = s_aSession.bBonus = 0, g = 0; if (s_aSession.iSlotCash < s_aSession.min_win * f) return generLosingPattern(), 1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0)), "res=true&win=false&pattern=" + JSON.stringify(_aFinalSymbols) +
            "&money=" + s_aSession.iMoney + "&freespin=" + s_aSession.iTotFreeSpin + "&bonus=false&bonus_prize=-1&bonus_win=0&cash=" + s_aSession.iSlotCash; if (Math.floor(100 * Math.random()) < s_aSession.win_occurrence) {
                ...
                } var k; m = 0; do { generateRandomSymbols(e, g); var l = checkWin(e, g, a), h = 0; for (k = 0; k < l.length; k++)h += l[k].amount; h *= f; var b = 0; k = -1; if (1 === g) { s_aSession.bBonus = 1; k = []; for (b = 0; b < s_aSession.bonus_prize_occur.length; b++)
                    for (var c = s_aSession.bonus_prize_occur[b], t = 0; t < c; t++)k.push(b); k = k[Math.floor(Math.random() * k.length)]; b = s_aSession.bonus_prize[k] * f } m++ } 
                    while (0 === l.length || b + h > s_aSession.iSlotCash || b + h < d);
                    s_aSession.iMoney = s_aSession.iMoney + 0 + 0;
                    $.post("update50", { _token: $('meta[name=csrf-token]').attr('content'), amount: s_aSession.iMoney + h + b, bet: userbet, user_id: user_id }, function (t) {
    
                    });
                    s_aSession.iMoney = s_aSession.iMoney + 0 + userbet;
                    s_aSession.iSlotCash =s_aSession.iSlotCash - h - b; 
                    1 === e && 2 < _iNumSymbolFreeSpin ? (s_aSession.bFreeSpin = 1, s_aSession.iTotFreeSpin = s_aSession.num_freespin[_iNumSymbolFreeSpin - 3]) : 1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0)); return "res=true&win=true&pattern=" + JSON.stringify(_aFinalSymbols) + "&win_lines=" + JSON.stringify(l) + "&money=" + s_aSession.iMoney + "&tot_win=" + h + "&freespin=" + s_aSession.iTotFreeSpin + "&bonus=" + s_aSession.bBonus + "&bonus_prize=" +
