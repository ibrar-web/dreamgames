function CGame(oData) {
    ...
    this._endReelAnimation = function () {
        ...
        if (_aWinningLine.length > 0) {
            ...
            if (_iTotWin > 0) {
                $.post("update30", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iMoney + _iTotWin,bet:_iCurBet,user_id:user_id }, function (t) {
                });
                _oInterface.refreshMoney(_iMoney + _iTotWin, 1);
                _iMoney += _iCurBet;
