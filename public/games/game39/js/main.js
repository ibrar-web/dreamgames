...
function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./games/game39/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./games/game39/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./games/game39/sprites/but_start.png");
...
function CMain(a) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo = [];
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "press_but", loop: !1, volume: 1, ingamename: "press_but" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "win", loop: !1, volume: 1, ingamename: "win" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "reels", loop: !1, volume: 1, ingamename: "reels" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "reel_stop", loop: !1, volume: 1, ingamename: "reel_stop" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "game_over_bonus", loop: !1, volume: 1, ingamename: "game_over_bonus" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "reel_bonus", loop: !1, volume: 1, ingamename: "reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "start_reel_bonus", loop: !1, volume: 1, ingamename: "start_reel_bonus" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "win_bonus", loop: !1, volume: 1, ingamename: "win_bonus" });
        s_aSoundsInfo.push({ path: "./games/game39/sounds/", filename: "start_reel", loop: !1, volume: 1, ingamename: "start_reel" });
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("but_bg", "./games/game39/sprites/but_play_bg.png");
        s_oSpriteLibrary.addSprite("but_exit", "./games/game39/sprites/but_exit.png");
        s_oSpriteLibrary.addSprite("bg_menu", "./games/game39/sprites/bg_menu.jpg");
        s_oSpriteLibrary.addSprite("bg_game", "./games/game39/sprites/bg_game.jpg");
        s_oSpriteLibrary.addSprite("paytable1", "./games/game39/sprites/paytable1.jpg");
        s_oSpriteLibrary.addSprite("paytable2", "./games/game39/sprites/paytable2.jpg");
        s_oSpriteLibrary.addSprite("paytable3", "./games/game39/sprites/paytable3.jpg");
        s_oSpriteLibrary.addSprite("mask_slot",
            "./games/game39/sprites/mask_slot.png");
        s_oSpriteLibrary.addSprite("spin_but", "./games/game39/sprites/but_spin_bg.png");
        s_oSpriteLibrary.addSprite("but_autospin", "./games/game39/sprites/but_autospin.png");
        s_oSpriteLibrary.addSprite("spin_bg", "./games/game39/sprites/spin_bg.png");
        s_oSpriteLibrary.addSprite("coin_but", "./games/game39/sprites/but_coin_bg.png");
        s_oSpriteLibrary.addSprite("info_but", "./games/game39/sprites/but_info_bg.png");
        s_oSpriteLibrary.addSprite("bet_but", "./games/game39/sprites/bet_but.png");
        s_oSpriteLibrary.addSprite("win_frame_anim", "./games/game39/sprites/win_frame_anim.png");
        s_oSpriteLibrary.addSprite("but_lines_bg",
            "./games/game39/sprites/but_lines_bg.png");
        s_oSpriteLibrary.addSprite("but_maxbet_bg", "./games/game39/sprites/but_maxbet_bg.png");
        s_oSpriteLibrary.addSprite("audio_icon", "./games/game39/sprites/audio_icon.png");
        s_oSpriteLibrary.addSprite("msg_box", "./games/game39/sprites/msg_box.png");
        s_oSpriteLibrary.addSprite("but_arrow_next", "./games/game39/sprites/but_arrow_next.png");
        s_oSpriteLibrary.addSprite("but_arrow_prev", "./games/game39/sprites/but_arrow_prev.png");
        s_oSpriteLibrary.addSprite("freespin_panel", "./games/game39/sprites/freespin_panel.png");
        s_oSpriteLibrary.addSprite("logo", "./games/game39/sprites/logo.png");
        s_oSpriteLibrary.addSprite("logo_freespin", "./games/game39/sprites/logo_freespin.png");
        s_oSpriteLibrary.addSprite("but_credits", "./games/game39/sprites/but_credits.png");
        s_oSpriteLibrary.addSprite("but_fullscreen", "./games/game39/sprites/but_fullscreen.png");
        s_oSpriteLibrary.addSprite("logo_ctl", "./games/game39/sprites/logo_ctl.png");
        for (var a = 1; a < NUM_SYMBOLS + 1; a++) s_oSpriteLibrary.addSprite("symbol_" + a, "./games/game39/sprites/symbol_" + a + ".png"), s_oSpriteLibrary.addSprite("symbol_" + a + "_anim", "./games/game39/sprites/symbol_" + a + "_anim.png");
        for (a = 1; a < NUM_PAYLINES + 1; a++) s_oSpriteLibrary.addSprite("payline_" +
            a, "./games/game39/sprites/payline_" + a + ".png");
        s_oSpriteLibrary.addSprite("bg_bonus", "./games/game39/sprites/bonus/bg_bonus.png");
        s_oSpriteLibrary.addSprite("but_spin_bonus", "./games/game39/sprites/bonus/but_spin_bonus.png");
        s_oSpriteLibrary.addSprite("leds", "./games/game39/sprites/bonus/leds.png");
        s_oSpriteLibrary.addSprite("wheel", "./games/game39/sprites/bonus/wheel.png");
...
function CMenu() {
    ...
    this._init = function () {
        ...
        SHOW_CREDITS ? (
            ...
            ), a = x.height / 2 + 10, f = x.height / 2 + 10, h = new CGfxButton(a, f, x, s_oAttachSection), h.addEventListener(ON_MOUSE_UP, this._onButCreditsRelease, this), d = a + x.width, e = f) : (d = x.height / 2 + 10, e = x.height / 2 + 10);
        x = window.document;
...
function CInterface(a, f, d) {
    ...
    this.refreshMoney = function (a) {
        $.post("update39", { _token: $('meta[name=csrf-token]').attr('content'), amount: a, user_id: user_id }, function (t) {
...
function _onSpin(a, f, d) {
    if (d > s_aSession.iMoney) _dieError("INVALID BET: " + d + ",money:" + s_aSession.iMoney);
        ...
        if (Math.floor(100 * Math.random()) < s_aSession.win_occurrence) {
            ...
            $.post("update39", { _token: $('meta[name=csrf-token]').attr('content'), amount: s_aSession.iMoney + h + b, bet: userbet, user_id: user_id }, function (t) {

            });
            s_aSession.iMoney = s_aSession.iMoney + 0 + userbet;
...
function CCreditsPanel() {
   // window.location.href = "home";
    ...
    // }; this.refreshButtonPos = function (a, b) { }; this.unload = function () { k.off("click", this._onLogoButRelease); e.unload(); e = null; s_oStage.removeChild(b) };
    // this._onLogoButRelease = function () { window.open("http://www.codethislab.com/index.php?&l=en", "_blank") }; this._init()
