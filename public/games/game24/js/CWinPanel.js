function CWinPanel(oParentContainer) {
    ...
    this.show = function(iWin, aWinList, aRank,_iTotBet) {
        $.post("update24", { _token: $('meta[name=csrf-token]').attr('content'), amount: iWin, id: 2,bet:_iTotBet ,user_id:user_id}, function(t) {
