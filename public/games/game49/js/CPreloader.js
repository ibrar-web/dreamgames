function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./games/game49/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./games/game49/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./games/game49/sprites/but_start.png");
