function CGame(oData) {
    ...
    this.placeFakeCardForStarting = function () {
        ...
        var oData = {   // image to use
            ...
            animations: {
                card_1_1: [0], card_1_2: [1], card_1_3: [2], card_1_4: [3], card_1_5: [4], card_1_6: [5], card_1_7: [6], card_1_8: [7],
    ...
    this.dealCards = function () {
        ...
        _iGameCash += _iCurBet;
        _oInterface.refreshMoney(_iMoney, _iCurBet);
        $.post("update49", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iMoney, user_id: user_id, bet: _iCurBet }, function (t) {
    ...
    this.assignWin = function (iRet) {
        ...
        if (_iCurWin > 0) {
            $.post("update49", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iMoney, user_id: user_id, bet: _iCurBet }, function (t) {
                _iMoney=_iMoney-_iCurWin+_iCurBet;
            });
        }
        _oInterface.refreshMoney(_iMoney, _iCurBet);
    };
