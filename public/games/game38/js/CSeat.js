function CSeat() {
    ...
    this.increaseCredit = function (iCreditToAdd, val) {
        if(val=='1'){
           // console.log('_iBetAnte',_iBetAnte,_iBetRaise,iCreditToAdd);
            $.post("update38", { _token: $('meta[name=csrf-token]').attr('content'), amount:  _iCredit + iCreditToAdd, type: '2' ,bet:_iBetAnte+_iBetRaise,user_id:user_id}, function(t) {
                
            });
            _iCredit+=_iBetAnte+_iBetRaise;
            return; 
        }
