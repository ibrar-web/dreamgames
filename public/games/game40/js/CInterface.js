function CInterface() {
    ...
    this.refreshCredit = function(iValue, val) {
        //console.log('iValue', iValue, 'val', val);
        if(val=='3'){
            _oCreditNum.refreshText(TEXT_CURRENCY + iValue);
            return;
        }
        $.post("update40", { _token: $('meta[name=csrf-token]').attr('content'), amount: iValue, type: val,user_id:user_id }, function(t) {
