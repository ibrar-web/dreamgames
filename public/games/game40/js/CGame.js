function CGame(oData) {
    ...
    this.releaseWheel = function () {
        ...
        if (WHEEL_SETTINGS[_iCurWin].prize * _iMultiply > 0) {
            $.post("update40", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iCurCredit + WHEEL_SETTINGS[_iCurWin].prize * _iMultiply, type: val,bet:_iCurBet,user_id:user_id}, function(t) {
               
            });
            _iCurCredit += _iCurBet;
            _oInterface.refreshCredit(_iCurCredit, '3');
        }
