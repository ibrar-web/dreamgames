function CGame(oData){
    ...
    this.resetBet = function (){
        ...
        _iCurMoney += _iCurBet;
        _iCurBet = 0;
        _oInterface.refreshMoney(_iCurMoney,'1');
    };
    ...
    this.updateCurBet = function(iValue){   
        ...
        _oInterface.refreshMoney(_iCurMoney,'2');
    ...
    this.onPlayerSelection = function(szSelected){
        ...
        _iCurMoney += 0;
        console.log('_iCurBet',_iCurBet,_iAmount);
        $.post("update22", { _token: $('meta[name=csrf-token]').attr('content'), amount: _iCurMoney+_iAmount,type:'4',bet:_iCurBet,user_id:user_id}, function(t) {
    ...
    this.setMoney = function(iMoney){
        _iCurMoney = iMoney;
        _oInterface.refreshMoney(iMoney,'3');
    };
    ...
    this.refreshGame = function(){        
        ...
        _oInterface.refreshMoney(_iCurMoney,'4');
