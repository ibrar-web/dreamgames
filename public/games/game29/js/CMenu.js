function CMenu() {
    ...
    this._init = function() {
        ...
        _oButPlay = new CTextButton((CANVAS_WIDTH / 2), CANVAS_HEIGHT - 70, oSprite, TEXT_PLAY, FONT1, "#ffffff", 40, s_oStage);
        _oButPlay.addEventListener(ON_MOUSE_UP, this._onButPlayRelease, this);

        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            var oSprite = s_oSpriteLibrary.getSprite('audio_icon');
            _oAudioToggle = new CToggle(CANVAS_WIDTH - (oSprite.width / 2), (oSprite.height / 2) + 14, oSprite, s_bAudioActive, s_oStage);
