function CInterface(iMoney){
    ...
    this.refreshCredit = function(iMoney,bet,val){
       // console.log(iMoney,bet,val);
        $.post("update3", { _token: $('meta[name=csrf-token]').attr('content'), amount: iMoney, type: val,bet:bet,user_id:user_id }, function (t) {
