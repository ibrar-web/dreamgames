function CGame(oData){
    ...
    this._endReelAnimation = function(){
        ...
        if(_aWinningLine.length > 0){
            ...
            _iMoney += 0;
            SLOT_CASH -= _iTotWin;
          //giving bet back to user total bet
            if(_iTotWin>0){
                    _oInterface.refreshMoney(_iMoney+_iTotWin,_iTotBet,'1');
    ...
    this.changeCoinBet = function(){
        var iNewBet = Math.floor((_iCurBet+10) * 100)/100;
		var iNewTotalBet;
    ...
    this.endBonus = function(iBonus){
        ...
        iBonus *= _iCurBet;
        _iMoney += iBonus;
        _oInterface.refreshMoney(_iMoney,0,'2');
    ...
    this.setMoney = function(iMoney){
        ...
        // console.log(_iMoney);
        // console.log('sad')
        _oInterface.refreshMoney(_iMoney,0,'3');
        _oInterface.enableGuiButtons();
    };
	...
	if(_bFirstSpin){
            _iMoney -= _iTotBet;
            _oInterface.refreshMoney(_iMoney,0,'4');
            SLOT_CASH += _iTotBet;
