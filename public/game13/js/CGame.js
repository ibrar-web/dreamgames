function CGame(oData){
    ...
    this.setCredit = function(iMoney){
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet,1,userwin);
    };
	...
	if(_bFold){
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet,2,userwin);
        $.post("update13", { _token: $('meta[name=csrf-token]').attr('content'),amount:_oSeat.getCredit(),bet:userbet,win:userwin,user_id:user_id}, function (t) {
    ...
    this._playerWin = function(szText){
        var iWinAmount = _iTotWin+_iAnteBonusWin;
         userwin=iWinAmount;
         userbet=_oSeat.getbet();
        _oSeat.increaseCredit(iWinAmount,'1');
        _oSeat.clearbet();
    ...
    this._playerLose = function(bFold){
        ...
        if(_iAnteBonusWin>0){
            _oSeat.increaseCredit(_iAnteBonusWin,'2');
    ...
    this._standOff = function(){
        ...
        _oSeat.increaseCredit(iWinAmount,'3');
        _iGameCash -= iWinAmount;
    ...
    this._checkPlusWin = function(){
        if(_iTotWinPairPlus >0){
            _oSeat.increaseCredit(_iTotWinPairPlus,'4');
    ...
    this.setBet = function(iFicheIndex,iTypeBet){
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet,3,userwin);
    };
    ...
    this.setPairPlusBet = function(iFicheIndex){
        ...
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet,4,userwin);
    };
    ...
    this.clearBets = function(){
        ...
        if(iCurBet>0){
            _bPairPlus = false;
            _oSeat.clearBet();
            _oSeat.increaseCredit(iCurBet,'5');
            _iGameCash -= iCurBet;
            _oInterface.refreshCredit(_oSeat.getCredit(),userbet,5,userwin);
    ...
    this.rebet = function(){
        ...
        _oInterface.enable(true,false,false);
        _oInterface.refreshCredit(_oSeat.getCredit(),userbet,6,userwins);
