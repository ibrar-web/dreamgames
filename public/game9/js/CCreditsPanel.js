function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +270, y: 280};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
        
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"36px "+PRIMARY_FONT, "#ffffff");
        ...
        _oLink = new createjs.Text("www.codethislab.com","34px "+PRIMARY_FONT, "#ffffff");
        _oLink.x = CANVAS_WIDTH/2;
        _oLink.y = CANVAS_HEIGHT/2+50;
